  ...
  return (
    <nav className="sticky top-0 z-50 bg-github-bg/80 backdrop-blur-md border-b border-github-border">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 text-github-text hover:text-github-accent transition-colors">
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs text-github-muted hidden sm:inline">@{username}</span>
          <Link
            href={`/resume?user=${username}`}
